...
- **2026-07-24** — Progressive-validation flagged a `model` change (`andere` → `s9`); confirmed this is a legitimately new model introduced on site, not a bug. [Slack](https://preskok.slack.com/archives/C0859KQ45B2/p1784893095058969)
