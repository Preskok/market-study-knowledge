...
## Current status
🟡 **2026-06-12 WATCH** — Drop from 4k to 3.5k; Alfa Romeo listing returning 404 (intermittent - browser also shows 404 sometimes). Site threshold adjusted (sofibrie source now 4k+, old threshold was for <2k). Monitoring until Monday.
